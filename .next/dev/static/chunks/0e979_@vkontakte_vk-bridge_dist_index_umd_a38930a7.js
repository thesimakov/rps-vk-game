...
"[project]/node_modules/.pnpm/@vkontakte+vk-bridge@2.15.11/node_modules/@vkontakte/vk-bridge/dist/index.umd.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
!function(e, n) {
    ...
    var i, p = "undefined" != typeof window, s = Boolean(p && window.AndroidBridge), u = Boolean(p && window.webkit && window.webkit.messageHandlers && window.webkit.messageHandlers.VKWebAppClose), c = Boolean(p && window.ReactNativeWebView && "function" == typeof window.ReactNativeWebView.postMessage), d = p && !s && !u, l = d && /(^\?|&)vk_platform=mobile_web(&|$)/.test(location.search), f = d ? "message" : "VKWebAppEvent", b = o([
        ...
        "VKWebAppShowImages"
    ], !0), A = p ? window.AndroidBridge : void 0, v = u ? window.webkit.messageHandlers : void 0, h = d ? parent : void 0;
                        ...
                        switch(t.label){
                            ...
                            case 1:
                                return t.trys.push([
                                    ...
                                    4,
                                    _("SetSupportedHandlers")
                                ];
                            case 2:
                                return n = t.sent(), i = new Set(n.supportedHandlers), [
                                    3,
                                    4
                                ];
                            case 3:
                                return t.sent(), i = new Set([
                                    "VKWebAppInit"
                                ]), [
                                    3,
                                    4
...
//# sourceMappingURL=0e979_%40vkontakte_vk-bridge_dist_index_umd_a38930a7.js.map