module.exports = [
"[project]/node_modules/.pnpm/@vkontakte+vk-bridge@2.15.11/node_modules/@vkontakte/vk-bridge/dist/index.es.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ function promisifySend(sendEvent, subscribe, instanceId) {
    ...
    subscribe(function(event) {
        ...
        if ('request_id' in event.detail.data) {
            var _a = event.detail.data, requestId = _a.request_id, data = __rest(_a, [
                "request_id"
            ]);
            if (requestId) {
...
/** Is the client side runtime environment */ var IS_CLIENT_SIDE = ("TURBOPACK compile-time value", "undefined") !== 'undefined';
/** Is the runtime environment an Android app */ var IS_ANDROID_WEBVIEW = Boolean(IS_CLIENT_SIDE && window.AndroidBridge);
/** Is the runtime environment an iOS app */ var IS_IOS_WEBVIEW = Boolean(IS_CLIENT_SIDE && window.webkit && window.webkit.messageHandlers && window.webkit.messageHandlers.VKWebAppClose);
...
/** Is the runtime environment a browser */ var IS_WEB = IS_CLIENT_SIDE && !IS_ANDROID_WEBVIEW && !IS_IOS_WEBVIEW;
/** Is the runtime environment m.vk.ru */ var IS_MVK = IS_WEB && /(^\?|&)vk_platform=mobile_web(&|$)/.test(location.search);
/** Is the runtime environment vk.ru */ var IS_DESKTOP_VK = IS_WEB && !IS_MVK;
/** Type of subscribe event */ var EVENT_TYPE = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : 'VKWebAppEvent';
/** Methods supported on the desktop */ var DESKTOP_METHODS = __spreadArray([
    'VKWebAppInit',
...
/** Cache for supported methods */ var supportedHandlers;
/** Android VK Bridge interface. */ var androidBridge = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : undefined;
/** iOS VK Bridge interface. */ var iosBridge = IS_IOS_WEBVIEW ? window.webkit.messageHandlers : undefined;
/** Web VK Bridge interface. */ var webBridge = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : undefined;
 ...
 */ function createVKBridge(version) {
    /** Current frame id. */ var webFrameId = undefined;
    /** List of functions that subscribed on events. */ var subscribers = [];
    /** Uniq instance ID */ var instanceId = createInstanceId();
    /**
    ...
    } else if (("TURBOPACK compile-time value", "undefined") !== 'undefined' && 'addEventListener' in window) //TURBOPACK unreachable
    ;
    /**
                ...
                switch(_a.label){
                    case 0:
                        if (IS_ANDROID_WEBVIEW || IS_IOS_WEBVIEW) {
                            return [
                                2 /*return*/ ,
                                supportsInner(method)
                            ];
                        }
                        if (supportedHandlers) {
                            return [
                                2 /*return*/ ,
                                supportedHandlers.has(method)
                            ];
                        }
                        _a.label = 1;
                    case 1:
                        ...
                        return [
                            4 /*yield*/ ,
                            sendPromise('SetSupportedHandlers')
                        ];
                    case 2:
                        response = _a.sent();
 ...
 */ function applyMiddleware() {
    ...
    return function(bridge) {
        ...
        return __assign(__assign({}, bridge), {
            send: send
        });
    };
}
...
//# sourceMappingURL=0e979_%40vkontakte_vk-bridge_dist_index_es_2000a9e5.js.map